            ...
            <div class="content">
                <el-card shadow="never">
                    ...
                    <el-table :data="configData" style="width: 100%">
                        <el-table-column label="配置详情" width="300px">
                            <template #default="scope">
                                <div class="detail">
                                    <div>实例类型：{{ scope.row.type }}</div>
                                    <div>数据盘{{ scope.row.dataDisk }}</div>
                                </div>
                            </template>
                        </el-table-column>
                        <el-table-column prop="area" label="地域" />
                ...
                <el-card style="margin-top: 10px;" shadow="never">
                    <!-- 服务条款 -->
                    <div class="agreement">
                        <div class="agreement descriptive"><el-checkbox v-model="agreement" label="我已阅读并已同意JIMCLOUD"
                                size="large" /><span class="agreement-btn"
                    ...
                    <!-- 是否自动续费 -->
                    <div class="renewal">
                        <el-checkbox v-model="renewal" label="开启订单到期自动续费" size="large" />
                    </div>
                </el-card>
            </div>
        </ModuleCard>
        ...
        <div class="total">
            <ModuleCard :showHeader="false" :isPadding="false">
                <div class="content">
                    <div class="box">
                        <div class="text">
                            <div class="total-price">应付款：<span>$60.00</span></div>
                            <el-popover :teleported="false" placement="top-start" title="费用明细" :offset="80" :width="300"
                                trigger="click">
                                <template #reference>
                        ...
                        <el-button type="primary" size="large" @click="goView('/pay')">去付款</el-button>
                    </div>
                </div>
            </ModuleCard>
        </div>
