<template>
    <!-- 应用场景 -->
    <ModuleCard bg-color="#f9f9f9" headline-text="应用场景">
        <div class="ecs-scence">
            <HorizontalMenu menu-class="scenceMenu" align="space-evenly" @sandNavData="getNavData" :menus="data">
            </HorizontalMenu>
            <div class="content">
                <div class="item">
                    <div class="item-img"><img :src="currentNavData.imgUrl"></div>
                    <div class="item-txt">
                        <div class="li-item" v-for="(item, index) in currentNavData.datas"><b>{{ item.title }}</b>
                            <ul>
                        ...
                        <div class="li-block"><b>推荐搭配使用</b>
                            <div>
                                <el-button v-for="item in btns" @click="gotoView(item.path)">{{ item.text }}</el-button>
                            </div>
                        </div>
                    </div>
                </div>
...
let currentNavData = ref(props.data[0] as any)
let getNavData = (item: any) => {
    currentNavData.value = item
}

let router = useRouter()
let gotoView = (url: any) => {
    router.push(url)
}
